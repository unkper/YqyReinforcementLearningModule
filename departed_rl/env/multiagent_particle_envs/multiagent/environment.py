...
import numpy as np
from departed_rl.env.multiagent_particle_envs.multiagent.multi_discrete import MultiDiscrete
...
class MultiAgentEnv(gym.Env):
    ...
    def _get_done(self, agent):
        if self.done_callback is None:
            return False
        return self.done_callback(self)
    ...
    def render(self, mode='human'):
        ...
        for i in range(len(self.viewers)):
            ...
            if self.viewers[i] is None:
                ...
                from departed_rl.env.multiagent_particle_envs.multiagent import rendering

...
from rl.utils.classes import SaveNetworkMixin, OrnsteinUhlenbeckActionNoise, Experience, ModelBasedMAAgentMixin, \
    MAAgentMixin
...
class G_MADDPGAgent(ModelBasedMAAgentMixin, MAAgentMixin, SaveNetworkMixin, Agent):
    ...
    def __init__(self, env: Env = None,
        ...
        self.model = EnsembleDynamicsModel(network_size, elite_size, sum(self.state_dims), sum(self.action_dims), self.env.agent_count, model_hidden_dim, use_decay)

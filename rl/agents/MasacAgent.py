...
class MATD3Agent(MAAgentMixin, SaveNetworkMixin, Agent):
    ...
    def __init__(self, env: Env = None,
        ...
        super(MATD3Agent, self).__init__(env, capacity, gamma=gamma, n_rol_threads=n_rol_threads)
        self.state_dims = []
        ...
        def loss_callback(agent:MATD3Agent, loss):
            ...
            if agent.total_episodes_in_train % (self.log_frequent * self.n_rol_threads) == 0 \

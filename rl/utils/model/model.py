...
class EnsembleModel(nn.Module):#其线性层为[s1, s2, ensemble_size]等于将多个model分线性层整合起来
    def __init__(self, state_size, action_size, reward_size, ensemble_size, hidden_size=200, learning_rate=0.001, use_decay=False):
...
class EnsembleDynamicsModel():
    ...
    def _save_best(self, epoch, holdout_losses):
        ...
        if self._epochs_since_update > self._max_epochs_since_update: #如果loss变化超过max_epochs次，就跳出训练
            return True
        else:
            return False

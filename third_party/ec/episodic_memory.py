...
class EpisodicMemory(object):
    ...
    Args:
      observation_shape: Shape of an embed observation!!!
    ...
    def reset(self, show_stats=True):
        ...
        self._obs_memory = np.zeros([self._capacity] + list(self._observation_shape))
    ...
    Args:
      observation: The input embed observation.

...
class Params:
    ...
    n_rollout_threads = 8  # 启用的总线程数，用于环境经验的收集工作
    buffer_length = int(5e5)  # "Set to 5e5 for ViZDoom (if memory limited)"
    train_time = int(1e6)
    ...
    batch_size = 128  # set 128 for vizdoom
    save_interval = 20000
    pol_hidden_dim = 32
    critic_hidden_dim = 256  # set 256 for vizdoom
    nonlinearity = "relu"  # relu or leaky_relu
    pi_lr = 0.0005  # 0.0005 for vizdoom
    q_lr = 0.0005  # 0.0005 for vizdoom
    phi_lr = 0.04
    adam_eps = 1e-8
    q_decay = 1e-3
    phi_decay = 1e-3
